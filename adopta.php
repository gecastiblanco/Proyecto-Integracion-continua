...
<body class="color-fondo">
  <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark fixed-top color-poli"> <!-- INICIO MENU DE NAVEGACION - HUGO ANGULO-->
    <div class="container">
...
</nav><!-- FIN MENU DE NAVEGACION - HUGO ANGULO-->
<header>  <!-- INICIO HEADER- HUGO ANGULO-->
</header><!-- FIN HEADER- HUGO ANGULO-->
<!-- CONTENIDO PRINCIPAL -->
<div class="container">
  <h1 class="my-4 text-poli">Proceso de Adopción</h1><!-- TITULO DE LA PAGINA - LEONARDO OMAÑA: se creo un H1 y una clase para el titulo de cada pagina-->
  <hr>
  <ol class="breadcrumb">
  ...
  <img class="img-fluid rounded mb-4" src="http://placekitten.com/g/1200/300" alt=""><!-- IMAGEN DESCRIPTIVA DE SECCION - HUGO ANGULO: imagen aleatoria de una servicio de internet temporal hasta elegir la imagen final-->
  <p style="display: block; padding: 50px 0px 80px 0px;">
    Gracias, hemos recibido tu solictud. Alguien de R.E.U.M.A. lo contactara pronto!.
  </p>
  <br>
  <br>
  <hr>
  <div class="row"><!-- INICIO SECCION MAS INFORMACION - LEONARDO OMAÑA : seccion para agregar informacion general para complementar el contenido principal de la pagina en la que se encuentra, se hizo para texto e imagenes o graficas en una proporcion 70/30-->
    <div class="col-lg-8 text-poli"><!-- TEXTO DUMMY - LEONARDO OMAÑA: se creo una lista, un h2 y se inserto una imagen aleatoria de un servicio en linea-->
    ...
    <div class="col-lg-4">
      <img src="http://placekitten.com/g/350/280" /><!-- IMAGEN ALEATORIA COMO PLACEHOLDER - LEONARDO OMAÑA -->
    </div>
  </div>
  <!-- FIN SECCION MAS INFORMACION - LEONARDO OMAÑA : seccion para agregar informacion general para complementar el contenido principal de la pagina en la que se encuentra, se hizo para texto e imagenes o graficas en una proporcion 70/30-->
  <hr>
  <!-- INICIO LLAMADO A LA ACCION CTA- LEONARDO OMAÑA : Se creó un link a la sección de contáctenos y se agregó un tag "p" para que la persona quiera preguntar mas cosas-->
  <div class="row mb-4">
  ...
  <!-- FIN LLAMADO A LA ACCION CTA- LEONARDO OMAÑA : Usado para motivar a las personas a realizar una accion importante, en este caso Adoptar-->
</div>
